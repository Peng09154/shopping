...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content0">
			...
			<div id="title_1">{{$product->title}}</div>
			<div id="content1">
				<img id="commodity" src="{{asset($product->pic)}}">
				
			</div>
			<div  id="content2">
				<div id="content3">
					<li>直購價: ${{$product->price}}</li>
					<li>庫存: {{$product->stock}}</li>
					
					<ul>
						<a href="{{url('backend/orders/send/'.$product->id)}}"><button>直接購買</button></a>
					</ul>	
				</div>
