...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content1">
			...
			<table id="table_cgy">
			    <thead>
			    	<a href="{{url('backend/carousels/create')}}"><button id="thead-button">新增</button></a>
			        <tr>
			        	<th>數字次序</th>
			            <th>圖片</th>
			            <th>名稱</th>
			    ...
			    <tbody>
			        ...
			        <tr>
						<td>{{$carousel->sort}}</td>
			            <td><img id="commodity" src="{{$carousel->pic}}"></td>
			            <td>{{$carousel->name}}</td>
			            <td>
			        		<a href="{{url('carousels/'. $carousel->id .'/edit')}}"><img id="editclose" src="{{asset('images\icons\features\edit.png')}}"></a>
			        		<a href="{{url('backend/carousels/del/'.$carousel->id)}}"><img id="editclose" src="{{asset('images\icons\features\close3.png')}}"></a>
			        	</td>
			        </tr>
			        @endforeach
