...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content1">
			...
			<table id="table_cgy">
			    <thead>
			    	<a href="{{url('cgys/create')}}"><button id="thead-button">新增</button></a>
			        <tr>
			        	<th>數字次序</th>
			        	<th>類別</th>
			            <th>圖片</th>
			    ...
			    <tbody>
			    	@foreach ($cgies as $cgy)
						...
						<td>{{$cgy->sort}}</td>
			        	<td>{{$cgy->title}}</td>
			            <td><img id="commodity" src="{{$cgy->pic}}"></td>
			       		<td>
			        		<a href="{{url('cgys/'. $cgy->id .'/edit')}}"><img id="editclose" src="{{asset('images\icons\features\edit.png')}}"></a>
			        		<a href="{{url('cgys/del/'.$cgy->id)}}"><img id="editclose" src="{{asset('images\icons\features\close3.png')}}"></a>
			        	</td>
			        </tr>
			    	@endforeach
